...
/*
 * use cache for show toast
//Cache::set('message',['severity'=>'info','summary'=>'Добавление записи','detail'=>'Запись была добавлена'])
severity?: "error" | "info" | "success" | "warn" | "secondary" | "contrast"
summary :string
detali:string
*/
...
/*
  ...
  */
namespace Kovyakin\Components\app\Table;
...
class Table implements Components
{
    use ClassName;
     ...
     * @Use show_index Set true to show index of item
     */
    protected static bool $show_index = false;
    /**
     * @var bool
     * @Use alternating prop to color alternating (even and odd) rows.
     */
     ...
     * @Use border-cell  set true to show borderof header item and body item
     */
    protected static bool $border_cell = false;
     ...
     * Set font-size to header table
     */
    protected static string $font_size_header = '';
    /**
     * @var string
     * REQURED!
     * Set font-size to body table
     */
    protected static string $font_size_body = '';
    /**
     * @var string
     * REQURED!
     * Set color-font to body table, example #e1e1e1
...
//        'easy_table_loading_mask_background_color' => '#2d3a4f',
     ...
     * @Use show_block_search to show this block
     */
    protected static bool $show_block_search = false;

    protected static bool $button_add = false;

    /**
     * @var bool
     * use useItemSelected to selected items
     */
    protected static bool $useItemSelected = false;

    /**
     * @var bool
     * use useRating customizable component for star ratings.
     */
    protected static bool $useRating = false;
     ...
     * }
     */
    protected static bool $allowGroupDelete = false;
     ...
     * ['text' => "is Active", 'value' => "checkbox3"],
     */
    protected static bool $useToast = false;
...
//        ['text' => "Operation", 'value' => "operation"], // for edit or delete record in table. value'=> "operation" -
     ...
     * use column_operation for edit or delete record in table
     */
    protected static bool $column_operation = false;
    ...
    /**
     * @return Collection
     * @Use DataTable  getting data from the model
     */
